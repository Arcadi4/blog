          ...
          <SceneReveal delayMs={180} distance="far">
            ...
            >
              ...
              <div className="col-span-3 col-start-7">
                <p>{article.excerpt}</p>
                <p className="mt-2 -translate-x-2 font-mono text-xs leading-none text-klein uppercase opacity-0 transition duration-300 group-hover:translate-x-0 group-hover:opacity-100 motion-reduce:transition-none">
                  Read article →
                </p>
              </div>
            </Link>
